...
// Custom
Cell.prototype.removeMass = function(n) {
    this.mass = Math.max(this.mass - n,this.owner.gameServer.config.playerMinMassDecay);
};
...
Cell.prototype.getSpeed = function() {
    ...
    return this.owner.gameServer.config.playerSpeed * 745.28 * Math.pow(this.mass, this.owner.gameServer.config.playerSpeedDecMass) * 50 / 1000;
};
